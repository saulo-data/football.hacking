...
if st.session_state['logged_in']:
    ...
    def get_stats(cups: list, team: str, league: str, seasons: list) -> list:
        stats = list(col.aggregate([{"$match": {"general.country": {"$nin": cups}, 'xg_coverage': True, 'general.season': {'$in': seasons}, "general.league": league, "$or": [{"teams.home.name": team}, {"teams.away.name": team}]}}, 
    ...
    squads = get_teams_dict(venue='home', collection=col, seasons=SEASONS, leagues=leagues)
